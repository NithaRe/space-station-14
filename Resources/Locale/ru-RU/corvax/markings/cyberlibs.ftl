...
# Orienta
marking-CyberlimbRArmNanotrasen = Протез, правая рука (Orienta)
marking-CyberlimbLArmNanotrasen = Протез, левая рука (Orienta)
marking-CyberlimbRHandNanotrasen = Протез, кисть правой руки (Orienta)
marking-CyberlimbLHandNanotrasen = Протез, кисть левой руки (Orienta)
marking-CyberlimbRLegNanotrasen = Протез, правая нога (Orienta)
marking-CyberlimbLLegNanotrasen = Протез, левая нога (Orienta)
marking-CyberlimbRFootNanotrasen = Протез, правая стопа (Orienta)
marking-CyberlimbLFootNanotrasen = Протез, левая стопа (Orienta)
marking-CyberlimbTorsoNanotrasen = Протез, туловище (Orienta)
# Xion
