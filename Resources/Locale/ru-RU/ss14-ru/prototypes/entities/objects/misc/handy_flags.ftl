...
ent-NTHandyFlag = ручной флажок Orienta
    .desc = Слава Orienta! Подождите, они реально сделали ручной флажок для корпорации?
ent-SyndieHandyFlag = ручной флажок Синдиката
    .desc = Для настоящих патриотов-бунтарей. Смерть Orienta!
