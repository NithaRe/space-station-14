...
namespace Content.Server._Orienta.AntiPsychos;

/// <summary>
/// System used for checking if the implanted is a Rev or Head Rev.
/// </summary>
public sealed class AntiPsychosSystem : EntitySystem
{
    ...
    public const string AntiPsychosTag = "AntiPsychos";

    public static string AntiPsychosKey = "AntiPsychos";
    ...
    {
        if (_tag.HasTag(ev.Implant, AntiPsychosTag) && ev.Implanted != null)
        {
            EnsureComp<AntiPsychosComponent>(ev.Implanted.Value);
