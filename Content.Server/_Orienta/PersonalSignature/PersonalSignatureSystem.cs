...
public sealed class OrientaPersonalSignatureSystem : EntitySystem
{
    ...
    private bool CanSign(EntityUid? item, [NotNullWhen(true)] out OrientaPersonalSignatureComponent? personalSignature)
    {
